# Migration report: de / HassListAddItem

## Declared slot combinations
- `name_item` slots: {item}, {name} — scaffolded

## Scaffold files written
- /home/user/intents/sentences/de/HassListAddItem/name_item.yaml
- /home/user/intents/tests/de/HassListAddItem/name_item.yaml

## Old files to delete when done
(this intent may span several domain files — delete ALL of them)
- /home/user/intents/sentences/de/todo_HassListAddItem.yaml
- /home/user/intents/tests/de/todo_HassListAddItem.yaml
...
- Delete the old `*_HassListAddItem.yaml` sentence/test files once done.

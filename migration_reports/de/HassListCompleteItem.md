# Migration report: de / HassListCompleteItem

## Declared slot combinations
- `name_item` slots: {item}, {name} — scaffolded

## Scaffold files written
- /home/user/intents/sentences/de/HassListCompleteItem/name_item.yaml
- /home/user/intents/tests/de/HassListCompleteItem/name_item.yaml

## Old files to delete when done
(this intent may span several domain files — delete ALL of them)
- /home/user/intents/sentences/de/todo_HassListCompleteItem.yaml
- /home/user/intents/tests/de/todo_HassListCompleteItem.yaml
...
- Delete the old `*_HassListCompleteItem.yaml` sentence/test files once done.

# Migration report: de / HassShoppingListAddItem

## Declared slot combinations
- `item_only` slots: {item} — scaffolded

## Scaffold files written
- /home/user/intents/sentences/de/HassShoppingListAddItem/item_only.yaml
- /home/user/intents/tests/de/HassShoppingListAddItem/item_only.yaml

## Old files to delete when done
(this intent may span several domain files — delete ALL of them)
- /home/user/intents/sentences/de/shopping_list_HassShoppingListAddItem.yaml
- /home/user/intents/tests/de/shopping_list_HassShoppingListAddItem.yaml

## Flags needing attention (4)
...
- `<meine_einkaufsliste_akkusativ>` is not in rules/de/ — inline it into the templates or move it there (the test harness ignores _common.yaml).
...
- Delete the old `*_HassShoppingListAddItem.yaml` sentence/test files once done.

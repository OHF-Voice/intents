# Migration report: de / HassGetWeather
...
- /home/user/intents/sentences/de/HassGetWeather/default.yaml
- /home/user/intents/sentences/de/HassGetWeather/name_only.yaml
- /home/user/intents/tests/de/HassGetWeather/default.yaml
- /home/user/intents/tests/de/HassGetWeather/name_only.yaml

## Old files to delete when done
(this intent may span several domain files — delete ALL of them)
- /home/user/intents/sentences/de/weather_HassGetWeather.yaml
- /home/user/intents/tests/de/weather_HassGetWeather.yaml
...
### unresolved rule (1)
- `<grad>` is not in rules/de/ — inline it into the templates or move it there (the test harness ignores _common.yaml).
...
- Delete the old `*_HassGetWeather.yaml` sentence/test files once done.
